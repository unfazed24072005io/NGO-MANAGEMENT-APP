...
export default function WorkingMemberSuggestion({ navigation }) {
  ...
  const SuggestionCard = ({ item }) => (
    <TouchableOpacity style={styles.suggestionCard} onPress={() => { setSelectedItem(item); setDetailModalVisible(true); }}>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateSubtext}>Share your suggestions to improve</Text>
            <TouchableOpacity style={styles.emptyButton} onPress={() => { resetForm(); setModalVisible(true); }}>
              <Text style={styles.emptyButtonText}>Submit Suggestion</Text>
            </TouchableOpacity>
          </View>
        }
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {selectedItem.status === 'resolved' && (
                  <View style={styles.detailSection}>
                    ...
                    <Text style={styles.detailValue}>This suggestion has been implemented</Text>
                  </View>
                )}
                ...
                {selectedItem.status === 'rejected' && (
                  <View style={styles.detailSection}>
                    <Text style={styles.detailLabel}>Status</Text>
                    <Text style={styles.detailValue}>This suggestion has been rejected</Text>
                  </View>
                )}
              </ScrollView>
            )}
