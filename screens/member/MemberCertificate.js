    ...
    >
      ...
      {cert.amount && (
        <View style={styles.certAmountBadge}>
          <Text style={styles.certAmountText}>₹{cert.amount}</Text>
        </View>
      )}
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.summaryGrid}>
        ...
        <View style={styles.summaryCard}>
          <Text style={styles.summaryValue}>
            {certificates.filter(c => c.type === 'membership' || c.type === 'volunteer').length}
          </Text>
              ...
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {selectedCert.amount && (
                  <View style={styles.detailSection}>
                    ...
                    <Text style={styles.detailValue}>₹{selectedCert.amount}</Text>
                  </View>
                )}

                <View style={styles.detailSection}>
                  <Text style={styles.detailLabel}>Purpose</Text>
                  <Text style={styles.detailValue}>{selectedCert.purpose || selectedCert.type || 'General'}</Text>
                </View>
