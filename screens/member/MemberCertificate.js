            ...
            <View style={[styles.certificateInnerBorder, { borderColor: color + '40' }]}>
              ...
              <View style={styles.certBodyView}>
                ...
                <View style={styles.certQuoteContainer}>
                  <Text style={styles.certQuote}>"Your generosity transforms lives and builds a better tomorrow."</Text>
                </View>
              </View>
...
>
  ...
  const handleShare = async (cert) => {
    try {
      ...
      const message = `🏆 ${type.toUpperCase()} CERTIFICATE 🏆

This certificate is proudly presented to

${donorName}

${amount > 0 ? `in recognition of their generous contribution of

₹${amount.toLocaleString()}

for the purpose of` : 'for their valuable contribution to'}
...
${cert.paymentId ? `Payment ID: ${cert.paymentId}` : ''}
  ...
  <div class="certificate-wrapper">
    <div class="certificate">
      ...
      <div class="body">
        ...
        <div class="quote">"Your generosity transforms lives and builds a better tomorrow."</div>
      </div>
      <div class="divider"></div>
      <div class="footer">
        <div class="seal">
